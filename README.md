...
Final slide deck used for the presentation.

**Group2 — Image Classification with CNN — Model Comparison**
Full side-by-side comparison of all 9 models (architecture, training params, results).
...
### Additional folders
**cnn_models/** — saved `.keras` files for each trained model (reused across sessions)
